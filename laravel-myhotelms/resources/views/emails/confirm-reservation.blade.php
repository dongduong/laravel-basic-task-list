    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <span style="font-weight: bold;">
                {{ __('mail.reservation-confirm.heading') }}
            </span> <br>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('mail.reservation-confirm.dear', ['customer_name' => $reservation->guest->fullName()]) }},
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!! __('mail.reservation-confirm.greeting', [
        ...
        <div style="font-weight: bold;font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 20px !important;">
            {{ __('mail.reservation-confirm.summary') }}
        </div>

        <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
            <div style="line-height: 25px;">
                <div style="font-weight: bold;font-size: 16px;color: #242424;">
                    {{ __('mail.reservation-confirm.guest') }}
                </div>
                ...
                <div style="margin-bottom: 40px;">
                    {{ __('mail.reservation-confirm.phone') }} : {{ $reservation->guest->phone }} 
                </div>
        ...
        <div style="background: #FFFFFF;border: 1px solid #E8E8E8;border-radius: 3px;padding: 20px;margin-bottom: 10px">
            ...
            <div style="margin-bottom: 10px;">
                <label style="font-size: 16px;color: #5E5E5E;font-weight: bold;">
                    {{ __('mail.reservation-confirm.room-number') }}
                </label>
            ...
            <div style="margin-bottom: 10px;">
                <label style="font-size: 16px;color: #5E5E5E;font-weight: bold;">
                    {{ __('mail.reservation-confirm.room-type') }}
                </label>
                <span style="font-size: 18px;color: #242424;margin-left: 40px;">
            ...
            <div style="margin-bottom: 10px;">
                <label style="font-size: 16px;color: #5E5E5E;font-weight: bold;">
                    {{ __('mail.reservation-confirm.check-in-date') }}
                </label>
                <span style="font-size: 18px;color: #242424;margin-left: 40px;">
            ...
            <div style="margin-bottom: 10px;">
                <label style="font-size: 16px;color: #5E5E5E;font-weight: bold;">
                    {{ __('mail.reservation-confirm.check-out-date') }}
                </label>
                <span style="font-size: 18px;color: #242424;margin-left: 40px;">
        ...
        <div style="margin-top: 65px;font-size: 16px;color: #5E5E5E;line-height: 24px;display: inline-block">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('mail.reservation-confirm.final-summary') }}
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!! 
                    __('mail.reservation-confirm.help', [
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('mail.reservation-confirm.thanks') }}
            </p>
        </div>
    </div>
@endcomponent
