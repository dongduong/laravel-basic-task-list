    ...
    <div class="card-body">
        <form action="{{ route("admin.lessons.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('position') ? 'has-error' : '' }}">
                ...
                <input type="number" id="position" name="position" class="form-control" value="{{ old('position', isset($lesson) ? $lesson->position : '') }}" step="1" required>
            ...
            <div class="form-group {{ $errors->has('free_lesson') ? 'has-error' : '' }}">
                ...
                <input value="1" type="checkbox" id="free_lesson" name="free_lesson" {{ old('free_lesson', 0) == 1 ? 'checked' : '' }}>
