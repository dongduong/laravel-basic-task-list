...
-- Dumping database structure for laraecom
DROP DATABASE IF EXISTS `laraecom`;
CREATE DATABASE IF NOT EXISTS `laraecom` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `laraecom`;
...
-- Dumping data for table laraecom.avored_admin_users: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_categories: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_category_product: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_configurations: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_countries: ~106 rows (approximately)
...
-- Dumping data for table laraecom.avored_languages: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_migrations: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_oauth_clients: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_oauth_personal_access_clients: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_pages: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_products: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_product_images: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_product_property_integer_values: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_properties: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_property_dropdown_options: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_roles: ~0 rows (approximately)
...
-- Dumping data for table laraecom.avored_site_currencies: ~0 rows (approximately)
